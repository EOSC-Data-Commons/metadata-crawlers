...
API_BASE = "https://laji.fi/api/collections"

_FINBIF_CLIENT = httpx.Client(timeout=30)

def fetch_all_collections(params: Dict) -> Generator[Dict, None, None]:
    """
    Fetch all collections from the FinBIF API, iterating through pages.

    :param client: An instance of httpx.Client for making requests.
    ...
    while True:
        params["page"] = page
        response = _FINBIF_CLIENT.get(API_BASE, params=params)
...
def main():
    ...
    try:
        ...
        all_collections = list(fetch_all_collections(params))
        # Process collections
        ...
        # For now, just print the filtered collections
